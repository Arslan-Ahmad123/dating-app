					...
					<fieldset class="lw-fieldset mb-3">
						...
						<div id="lwTestCryptoInputField">
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control form-control-user" value="" id="lwCryptoTestToken" name="crypto_testing_publishable_key" placeholder="<?= __tr('Publish Key') ?>">
							</div>
							<!-- / Testing Crypto Secret Key -->
							<!-- Testing Crypto Secret Key -->
						<div class="mb-3">
					...
					<fieldset class="lw-fieldset mb-3">
						...
						<div id="lwLiveCryptoInputField">
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control form-control-user" value="" id="lwCryptoLiveToken" name="crypto_live_publishable_key" placeholder="<?= __tr('Publish Key') ?>">
							</div>
							<!-- / Live Coingate Token -->
							<!-- Testing Razorpay Secret Key -->
						<div class="mb-3">
